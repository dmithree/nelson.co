          ...
          * {
          ...
          @media (prefers-color-scheme: dark) {
            :root {
              ...
              --primary-100-transparent: rgba(29, 39, 53, 0.9);
        ...
        <style jsx global>{`
          * {
          ...
          :root {
            ...
            --primary-100: rgba(255, 255, 255, 1);
            --primary-200: rgba(241, 248, 247, 1);
            --primary-300: rgba(222, 242, 237, 1);
            --primary-400: rgba(204, 235, 227, 1);

            --accent-100: rgba(144, 187, 176, 1);
            --accent-200: rgba(108, 172, 156, 1);
            --accent-300: rgba(74, 156, 136, 1);
            --accent-400: rgba(19, 39, 34, 1);

            --text-primary: rgba(19, 39, 34, 1);
            --text-accent: var(--accent-300);
            --text-accent-bg: rgba(0, 201, 151, 0.1);
          }

          @media (prefers-color-scheme: dark) {
            :root {
              --primary-100: rgba(29, 53, 47, 1);
              --primary-200: rgba(23, 43, 38, 1);
              --primary-300: rgba(14, 32, 28, 1);
              --primary-400: rgba(5, 20, 17, 1);

              --primary-100-transparent: rgba(29, 53, 47, 0.9);

              --accent-100: rgba(81, 164, 143, 1);
              --accent-200: rgba(101, 174, 156, 1);
              --accent-300: rgba(118, 178, 163, 1);
              --accent-400: rgba(139, 193, 179, 1);

              --text-primary: rgba(255, 255, 255, 1);
              --text-accent: var(--accent-400);
              --text-accent-bg: rgba(61, 228, 150, 0.2);
            }
          }
